...
class AlunoController extends Controller
{
    ...
    {
        $alunos = Aluno::all();
        $alunos_nascimento_0510 = Aluno::where('data_nascimento', '2005-10-05')->get();
        return view('aluno.index', compact('alunos', 'alunos_nascimento_0510'));
   ...
   return view('aluno.contato');
    ...
    public function store(Request $request)
    {
        ...
        $aluno = Aluno::create([
            ...
            'telefone' => $request->contatoAluno->telefone,
            'foto' => 'imagens/' . $foto
        ]);
