        ...
        <form method="POST" action="{{ route('like', $publicacao->id) }}">
            ...
            <button type="submit" class="btn btn-light">
                @if(session("liked_{$publicacao->id}"))
                    <img src="{{ asset('imagens/flecha_cima_cheia.JPEG') }}" alt="like" width="20">
                @else
                    <img src="{{ asset('imagens/flecha_cima_vazia.JPEG') }}" alt="like" width="20">
                @endif
            </button>
        </form>
        ...
        <form method="POST" action="{{ route('dislike', $publicacao->id) }}">
            ...
            <button type="submit" class="btn btn-light">
                @if(session("disliked_{$publicacao->id}"))
                    <img src="{{ asset('imagens/flecha_baixo_cheia.JPEG') }}" alt="dislike" width="20">
                @else
                    <img src="{{ asset('imagens/flecha_baixo_vazia.JPEG') }}" alt="dislike" width="20">
                @endif
            </button>
        </form>
        @else
